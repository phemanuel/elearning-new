...
class MaterialController extends Controller
{
    ...
    public function store(AddNewRequest $request)
    {
        try {
            ...
            $lesson = Lesson::findOrFail($request->lessonId); // Ensures the lesson exists
            $courseId = $lesson->course_id;
            $segmentId = $lesson->segments_id;
            ...
            if ($request->hasFile('content')) {
                ...
                $allowedMimeTypes = [
                    ...
                    'video/quicktime', 'video/x-ms-wmv', 'video/mpeg', 'video/webm', 'video/ogg',
                ];
                ...
                if (in_array($mimeType, $allowedMimeTypes) && in_array($extension, $allowedExtensions)) {
                    ...
                    $material->file_size = $fileInfo['filesize'] ?? null;
                } else {
            ...
            if ($material->save()) {
                return response()->json([
                    ...
                    'redirectUrl' => route('lesson.show', encryptor('encrypt', $segmentId)),
                ]);
            }
