...
class LessonController extends Controller
{
    ...
    {        
        ...
        // Log the decrypted ID to check if it matches the expected course_id
        Log::info('Decrypted course ID:', ['decryptedId' => $decryptedId]);

        // Find the last segment by course_id
        $segment = Segments::where('id', $decryptedId)->first();
        
        // Get lessons associated with the last segment
        $lesson = Lesson::where('segments_id', $decryptedId)
            ->withCount('material') 
            ->orderBy('serial_no', 'asc')
            ->get();

        // Return the view with the segment and its lessons
