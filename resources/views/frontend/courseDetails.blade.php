                ...
                <div class="icon-with-date d-flex align-items-lg-center">
                    ...
                    <div class="icon-with-date-end d-flex align-items-center">
                        ...
                        @if($course->lesson < 9)
                                                    ...
                                                    @else
                                                    <p class="font-para--md">{{$course->lesson}} lessons</p>
                                                    @endif
                    </div>
                </div>
                        ...
                        <div class="tab-pane fade show active" id="pills-courseoverview" role="tabpanel"
                            ...
                            <div class="row course-overview-main mt-4">
                                <div class="course-overview-main-item">
                                    ...
                                    <p class="mb-3 font-para--lg" style="color: black;">{{$course->description_en}}</p>
                                </div>
                                <div class="course-overview-main-item">
                                    <h6 class="font-title--card">Requirements</h6>
                                    <p class="mb-2 font-para--lg" style="color: black;">{{$course->prerequisites_en}}</p>
                                </div>
                                <!-- <div class="course-overview-main-item">
                ...
                <div class="col-12 position-relative px-0 mx-0">
                    <div class="new__courses">
                        ...
                        <div class="contentCard contentCard--course contentCard--space">
                            ...
                            <div class="contentCard-bottom">
                                ...
                                <div class="contentCard-info d-flex align-items-center justify-content-between">
                                    <a href="instructor-profile.html"
                                        ...
                                        <img src="{{asset('uploads/users/'.$course->instructor?->image)}}"
                                            alt="client-image" class="rounded-circle" width="50" height="50" />
                            ...
                            <a href="{{route('courseDetails', ['id' => encryptor('encrypt', $rc->id)])}}" class="button button-lg button--primary">Enroll</a>
                    </div> 
                                        <!-- <span>3 Hours</span> -->
                                    </div>
                                </div>
