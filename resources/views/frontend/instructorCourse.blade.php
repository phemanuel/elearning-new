    ...
    <div class="container">
        <nav style="--bs-breadcrumb-divider: '>';" aria-label="breadcrumb">
            <ol class="breadcrumb align-items-center bg-transparent p-0 mb-0">
                ...
                <li class="breadcrumb-item">
                    <a href="{{route('searchInstructor')}}" class="fs-6 text-secondary">Instructors</a>
                </li>
                <li class="breadcrumb-item">
                    <a href="{{ route('instructorProfile', encryptor('encrypt', $instructor->id)) }}" class="fs-6 text-secondary">
                        {{$instructor->name_en}}
                    </a>
                </li>
                <li class="breadcrumb-item">
                            ...
                            <div class="accordion-body">
                                <form action="#" method="get">
                                    ...
                                    <div class="accordion-body__item">
                                        <div class="check-box">
                                            <input type="checkbox" class="checkbox-primary" name="category" value="1" checked
                                                >
                                            <label> All </label>
                                        </div>
